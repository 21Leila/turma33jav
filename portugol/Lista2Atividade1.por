...
//deve pagar um multa de R$ 4,00 por quilo excedente. João precisa que você faça um sistema que leia a variável P (peso de tomates) e verifique se há excesso. 
...
programa
{
	...
	funcao inicio()
	{
		...
		se
		(P> 50.00){
		escreva("Você excedeu o pese dos tomates em: "+ E + "kg e pagará " +M+ "de multa ")	
		}
		senao{
